...
from nlp_search import filter, get_origin_and_destination, get_dates
...
class TestNLPSearch(unittest.TestCase):
    ...
    def test_filter(self):
        ...
        filtered_sentence_without_tags = filter(raw, get_tags=False, language="english")
        ...
        raw = "Flights from New York to Los Angeles between October 2nd to November 21st"
        filtered_sentence_with_tags = filter(raw, get_tags=True, language="english")
    ...
    def test_get_origin_and_destination(self):
        ...
        parsed_tree = get_origin_and_destination(tagged_words)
    ...
    def test_get_dates(self):
        ...
        words = word_tokenize(raw)
        tagged_words = nltk.pos_tag(words)
        parsed_tree = get_dates(tagged_words)
...
if __name__ == "__main__":
    search = TestNLPSearch()
    filtered_sentences = search.test_filter()
    origin_detination = search.test_get_origin_and_destination()
    dates = search.test_get_dates()